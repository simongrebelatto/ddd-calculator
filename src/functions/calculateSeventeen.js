import { CalculateSeventeen } from "../class/CalculateSeventeen";

async function calculateSeventeen(org_ddd, minutes) {

  const planClass = new CalculateSeventeen();

  const plan = await planClass.calculateValueSeventeen(minutes);
